        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnboardingTemplateTasks_Departments_ResponsibleDepartmentId",
                        column: x => x.ResponsibleDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnboardingTemplateTasks_OnboardingTemplates_OnboardingTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnboardingTasks_Departments_ResponsibleDepartmentId",
                        column: x => x.ResponsibleDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnboardingTasks_Users_ResponsibleUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskStatusHistories_OnboardingTasks_OnboardingTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnboardingProcesses_OnboardingTemplateId",
                table: "OnboardingProcesses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnboardingTasks_ResponsibleDepartmentId",
                table: "OnboardingTasks",
                column: "ResponsibleDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingTasks_ResponsibleUserId",
                table: "OnboardingTasks",
                column: "ResponsibleUserId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingTemplateTasks_OnboardingTemplateId",
                table: "OnboardingTemplateTasks",
                column: "OnboardingTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingTemplateTasks_ResponsibleDepartmentId",
                table: "OnboardingTemplateTasks",
                column: "ResponsibleDepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskStatusHistories_OnboardingTaskId",
                table: "TaskStatusHistories",
